...
# 回测的基本参数的设定
BACKTEST_START_DATE = '2019-10-08'  # 回测开始日期
BACKTEST_END_DATE = '2019-11-05'  # 回测结束日期，测试结束日期不运用算法
INCLUDED_INDEX = ['510050.SH', '513100.SH', '513500.SH', '510500.SH', '511010.SH', '518880.SH', '159920.SZ', '159938.SZ']  # 股票池代码，用Wind代码
EXCLUDED_INDEX = []  # 剔除的股票代码
TRADING_DATES_LIST = ['05']  # 每月的调仓日期，非交易日寻找下一个最近的交易日
...
def on_backtest_finished(context, indicator):
    ...
    stock_file = open('investment_group_data\\stock_json2.json', 'w')
