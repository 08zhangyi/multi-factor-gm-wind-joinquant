...
# 回测的基本参数的设定
BACKTEST_START_DATE = '2019-08-05'  # 回测开始日期
BACKTEST_END_DATE = '2019-10-08'  # 回测结束日期，测试结束日期不运用算法
INCLUDED_INDEX = ['510050.SH', '513100.SH', '513500.SH', '510500.SH', '511010.SH', '518880.SH', '510230.SH', '159938.SZ']  # 股票池代码，用Wind代码
