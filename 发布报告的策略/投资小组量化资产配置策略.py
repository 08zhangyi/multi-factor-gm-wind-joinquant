...
# 国内股票部分配置方案
stock_pool_1_stock = ['159949.SZ', '512070.SH', '512660.SH', '512720.SH', '512760.SH', '515000.SH']
risk_budget_1_stock = [0.7, 0.9, 0.5, 0.8, 0.5, 0.6]  # 总权重固定为4个单位
risk_bounds_1_stock = np.array([[0.0, 1.0]] * len(stock_pool_1_stock))
# 国际部分配置方案
stock_pool_1_global = ['513050.SH', '513100.SH', '513500.SH', '518880.SH']
risk_budget_1_global = [0.4, 0.6, 0.6, 0.8]
...
# 国内股票部分配置方案
stock_pool_2_stock = ['159928.SZ', '159949.SZ', '931152.CSI', '510050.SH', '510300.SH', '510500.SH', '512760.SH', '512930.SH', '515050.SH', '931167.CSI']
risk_budget_2_stock = [0.2, 0.8, 0.3, 0.2, 0.3, 0.4, 0.9, 0.6, 0.1, 0.2]
risk_bounds_2_stock = np.array([[0.0, 1.0]] * len(stock_pool_2_stock))
# 国际部分配置方案
stock_pool_2_global = ['513050.SH', '513100.SH', '513500.SH', '518880.SH']
risk_budget_2_global = [0.4, 0.6, 0.6, 0.8]
risk_bounds_2_global = np.array([[0.0, 0.2]] * len(stock_pool_2_global))
# 合并为整体证券池
...
# 国内股票部分配置方案
stock_pool_3_stock = ['159949.SZ', '931152.CSI', '510050.SH', '510500.SH', '512720.SH', '512930.SH', '931167.CSI']
risk_budget_3_stock = [0.4, 0.8, 0.2, 0.2, 0.8, 0.8, 0.8 ]
risk_bounds_3_stock = np.array([[0.0, 1.0]] * len(stock_pool_3_stock))
# 国际部分配置方案
stock_pool_3_global = ['513050.SH', '513100.SH', '513500.SH', '518880.SH']
risk_budget_3_global = [0.4, 0.6, 0.6, 0.8]
risk_bounds_3_global = np.array([[0.0, 0.2]] * len(stock_pool_3_global))
# 合并为整体证券池
