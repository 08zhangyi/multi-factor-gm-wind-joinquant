...
# 国内股票部分配置方案
stock_pool_1_stock = ['159928.SZ', '159949.SZ', '510050.SH', '510500.SH', '515000.SH']
risk_budget_1_stock = [0.85, 0.3, 1.0, 1.0, 0.85]  # 总权重固定为4个单位
risk_bounds_1_stock = np.array([[0.0, 1.0]] * len(stock_pool_1_stock))
# 国际部分配置方案
stock_pool_1_global = ['513100.SH', '513500.SH', '518880.SH']
risk_budget_1_global = [0.85, 0.85, 0.9]  # 在区间[0.75, 0.75, 0.8]-[1.0, 1.0, 1.0]之间灵活调整
...
risk_budget_2_stock = [0.3, 0.4, 1.0, 1.0, 0.6, 0.4, 0.3]
...
# 国内股票部分配置方案
stock_pool_3_stock = ['510050.SH', '510300.SH', '510500.SH', '512170.SH', '512930.SH', '515700.SH']
risk_budget_3_stock = [1.0, 0.5, 1.0, 0.5, 0.5, 0.5]
risk_bounds_3_stock = np.array([[0.0, 1.0]] * len(stock_pool_3_stock))
# 国际部分配置方案
stock_pool_3_global = ['513100.SH', '513500.SH', '518880.SH']
risk_budget_3_global = [0.75, 0.75, 0.8]  # 在区间[0.75, 0.75, 0.8]-[1.0, 1.0, 1.0]之间灵活调整
