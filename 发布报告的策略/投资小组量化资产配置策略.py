...
risk_bounds_1_bond = np.array([[0.0, 1.0]])
# 国内股票部分配置方案
...
risk_budget_1_global = [0.85, 0.85, 0.8]  # 在区间[0.75, 0.75, 0.8]-[1.0, 1.0, 1.0]之间灵活调整
...
risk_bounds_2_bond = np.array([[0.0, 1.0]])
# 国内股票部分配置方案
...
risk_bounds_3_bond = np.array([[0.0, 1.0]])
# 国内股票部分配置方案
