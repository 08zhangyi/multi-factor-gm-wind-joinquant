...
# 国内股票部分配置方案
stock_pool_1_stock = ['159928.SZ', '159949.SZ', '510050.SH', '510300.SH', '512720.SH', '515000.SH']
risk_budget_1_stock = [0.6, 0.6, 0.7, 0.7, 0.8, 0.6]  # 总权重固定为4个单位
risk_bounds_1_stock = np.array([[0.0, 1.0]] * len(stock_pool_1_stock))
# 国际部分配置方案
stock_pool_1_global = ['513050.SH', '513100.SH', '513500.SH', '518880.SH']
risk_budget_1_global = [0.8, 0.0, 0.0, 0.4]  # 在区间[0.75, 0.75, 0.8]-[1.0, 1.0, 1.0]之间灵活调整
risk_bounds_1_global = np.array([[0.0, 0.2]] * len(stock_pool_1_global))
# 合并为整体证券池
...
# stock_weights_1['167501.XSHE'] = 0.06
# stock_weights_1['511010.XSHG'] = stock_weights_1['511010.XSHG'] - 0.15
# 输出文字信息
...
risk_bounds_2_bond = np.array([[0.4, 1.0]])
# 国内股票部分配置方案
stock_pool_2_stock = ['159928.SZ', '159938.SZ', '510050.SH', '510300.SH', '510500.SH', '512930.SH', '515050.SH']
risk_budget_2_stock = [0.3, 0.4, 0.9, 0.9, 0.6, 0.6, 0.3]
risk_bounds_2_stock = np.array([[0.0, 1.0]] * len(stock_pool_2_stock))
# 国际部分配置方案
stock_pool_2_global = ['513100.SH', '513500.SH', '518880.SH']
risk_budget_2_global = [0.75, 0.75, 0.8]  # 在区间[0.75, 0.75, 0.8]-[1.0, 1.0, 1.0]之间灵活调整
...
stock_weights_2['167501.XSHE'] = 0.06
stock_weights_2['511010.XSHG'] = stock_weights_2['511010.XSHG'] - 0.15
# 输出文字信息
...
risk_bounds_3_bond = np.array([[0.4, 1.0]])
# 国内股票部分配置方案
stock_pool_3_stock = ['510050.SH', '510300.SH', '510500.SH', '512170.SH', '512720.SH', '515050.SH', '930997.CSI']
risk_budget_3_stock = [0.6, 0.6, 0.6, 0.4, 0.8, 0.5, 0.5]
risk_bounds_3_stock = np.array([[0.0, 1.0]] * len(stock_pool_3_stock))
# 国际部分配置方案
stock_pool_3_global = ['513100.SH', '513500.SH', '518880.SH']
risk_budget_3_global = [0.85, 0.65, 0.8]  # 在区间[0.75, 0.75, 0.8]-[1.0, 1.0, 1.0]之间灵活调整
...
stock_weights_3['167501.XSHE'] = 0.06
stock_weights_3['511010.XSHG'] = stock_weights_3['511010.XSHG'] - 0.15
# 输出文字信息
