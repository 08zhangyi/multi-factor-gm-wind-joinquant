...
数据位置字典 = {'科目名称': 1, '市值': 7}
产品简称列表 = ['汇沣1号', '汇沣2号', '汇沣3号', '天盈12号', '天泽1号', '天利1号', '天盈13号', '抚顺特钢', '中惠1号', '天诚25号', '融通10', '融通5', '天沃1号']
# 结构为{'栏目名称': {'提取数据栏目1': 栏目位置1, '提取数据栏目2': 栏目位置2},}
读取栏目字典 = {'银行存款': {'银行存款': 数据位置字典['市值']},
          '清算备付金': {'清算备付金': 数据位置字典['市值']},
          '存出保证金': {'存出保证金': 数据位置字典['市值']},
          '现金类资产': {'银行存款': 数据位置字典['市值'], '清算备付金': 数据位置字典['市值'], '存出保证金': 数据位置字典['市值']},
          '股票投资': {'股票投资': 数据位置字典['市值']},
          '债券投资': {'债券投资': 数据位置字典['市值']},
          '基金投资': {'基金投资': 数据位置字典['市值']},
          '买入返售金融资产': {'买入返售金融资产': 数据位置字典['市值']},
          '证券投资规模': {'股票投资': 数据位置字典['市值'], '债券投资': 数据位置字典['市值'], '基金投资': 数据位置字典['市值']},
          '应收利息': {'应收利息': 数据位置字典['市值']},
          '应付管理人报酬': {'应付管理人报酬': 数据位置字典['市值']},
          '应付托管费': {'应付托管费': 数据位置字典['市值']},
          '应付交易费用': {'应付交易费用': 数据位置字典['市值']},
          '应交税费': {'应交税费': 数据位置字典['市值']},
          '证券清算款': {'证券清算款': 数据位置字典['市值']},
          '资产类合计': {'资产类合计': 数据位置字典['市值']},
          '负债类合计': {'负债类合计': 数据位置字典['市值']},
          '基金资产净值': {'基金资产净值': 数据位置字典['市值']},
...
for i, product_name in enumerate(产品简称列表):
    sheet_write.write(0, i+1, product_name)
